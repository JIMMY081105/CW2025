...
public final class ChinaStageDescriptionProvider {
    ...
    private static List<ChinaStage> createStages() {
        ...
        stages.add(new ChinaStage("Stage 1 - Inner Mongolia", "China/1.jpg", "Inner Mongolia is a northern region of China known for its wide grasslands and strong traditional Mongolian culture. Many people there enjoy horseback riding and celebrate colorful festivals. It also has large deserts, like the Gobi, with unique landscapes and wildlife. Inner Mongolia blends modern development with a lifestyle that’s closely connected to nature."));
        stages.add(new ChinaStage("Stage 2 - Shan Dong", "China/2.jpg", "Shandong is a coastal province in eastern China, known as the birthplace of Confucius. It’s home to Mount Tai, a historic mountain important in Chinese culture. Cities like Qingdao are known for beaches and well-known local beer. Shandong has a mix of history, culture, and seaside living."));
        ...
        stages.add(new ChinaStage("Stage 4 - Bei Jing ", "China/4.jpg", "Beijing is China’s capital and a city where ancient history stands right beside modern skyscrapers. It’s home to landmarks like the Forbidden City and the Great Wall nearby — sights you can’t find anywhere else. People come here for art, technology, and big national events. Beijing feels powerful and cultural, all at the same time."));
        ...
        stages.add(new ChinaStage("Stage 6 - Chong Qing", "China/6.jpg", "Chongqing is a major city in southwest China built among steep hills, so roads and buildings often rise up and down like a giant maze. It’s famous for spicy hotpot and nighttime city views glowing above the rivers. The city’s unique “mountain city” style means elevators, bridges, and cable cars are part of daily life. Chongqing feels bold, energetic, and full of heat — just like its food."));
        ...
        stages.add(new ChinaStage("Stage 18 - Shaan Xi", "China/18.jpg", "Shaanxi is a central Chinese province known for Xi’an, the ancient capital where the Terracotta Army guards the resting place of China’s first emperor. The province sits at a key starting point of the historic Silk Road, connecting China to distant lands. Its cuisine, especially chewy biangbiang noodles, has a bold and hearty flavor. Shaanxi stands out for deep history, strong cultural roots, and food you won’t forget."));
        stages.add(new ChinaStage("Stage 19 - Hai Nan", "China/19.jpg", "Hainan is China’s southern island province, known for its warm beaches, palm trees, and blue ocean. It’s a popular place for vacations, surfing, and fresh tropical fruits. The island also has volcanic parks and rainforests that show a different side of nature. With sunshine, nature, and island culture, Hainan feels like China’s tropical getaway."));
        ...
        stages.add(new ChinaStage("Stage 25 - Guang Xi", "China/25.jpg", "Guangxi is a southern region of China famous for its amazing karst mountains and rivers that look like scenes from a painting. It’s home to many ethnic groups, especially the Zhuang people, with colorful festivals and music. Popular places like Guilin and Yangshuo attract travelers who love nature and adventure. Guangxi stands out for its beautiful landscapes and diverse cultural traditions."));
        stages.add(new ChinaStage("Stage 26 - Xi Zang", "China/26.jpg", "Xizang is a high-altitude region in southwest China, often called the “Roof of the World” because of the Himalayas. It’s known for Tibetan culture with prayer flags, monasteries, and unique festivals. The breathtaking scenery includes snowy mountains, clear lakes, and wide grasslands. Xizang stands out for its spiritual atmosphere and majestic natural beauty."));
