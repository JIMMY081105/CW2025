...
public final class GameConstants {
    ...
    public static final int BOARD_BOTTOM_MARGIN = 16;
    ...
    public static double boardPixelWidth() {
        return BOARD_WIDTH * BRICK_SIZE + Math.max(0, BOARD_WIDTH - 1) * GRID_GAP;
    }

    public static double boardPixelHeight() {
        int visibleRows = visibleRows();
        return visibleRows * BRICK_SIZE + Math.max(0, visibleRows - 1) * GRID_GAP;
    }
    ...
    public static double boardAreaHeight() {
        return boardPixelHeight() + BOARD_FRAME_THICKNESS * 2 + BOARD_BOTTOM_MARGIN;
    }
